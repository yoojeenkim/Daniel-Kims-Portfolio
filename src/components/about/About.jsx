        ...
        <div className="intro" id="intro">
            ...
            <div className="right">
                <div className="wrapper">
                    {/* <p>Hello! My name is Daniel Kim. I specialise in creating beautiful, usable, professional websites using best practice and the latest W3C web standards guidelines. All my sites are lovingly hand coded.</p>
